...
- The action of turning text in smaller parts of text (tokens)
...
### tokenization on English text is much easier than on text such as Chinese or Japanese where the notion of a "word" isn't neatly separated by spaces
...
# Looking at the hyperparameters `r emo::ji("eyes")`
...
# Extracting the best hyperparameters `r emo::ji("first")`
...
# Evaluation the best model `r emo::ji("ruler")`
...
```{r, echo=FALSE}
max_imp <- log(max(abs(wi_data$Importance)))
