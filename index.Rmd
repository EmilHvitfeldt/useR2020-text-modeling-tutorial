...
![](https://github.com/allisonhorst/stats-illustrations/raw/master/rstats-artwork/parsnip.png)
...
# Now we have **features** plus a **model**
...
## Time to tune! `r emo::ji("lightning")`
